...
PATHS = [[path1offset, path1]]#[[path1offset, path1], [path2offset, path2]]
...
for offset, path in PATHS:
    ...
    with open(path, 'r') as file:
        ...
        for row in csv_reader:
            ...
            sensors[0].append(float(row[0]))
            sensors[1].append(float(row[1]))
            sensors[2].append(float(row[2]))
            sensors[3].append(float(row[3]))
            sensors[4].append(float(row[4]))
            sensors[5].append(float(row[5]))
            sensors[6].append(float(row[6]))
            sensors[7].append(float(row[7]))
            sensors[8].append(float(row[8]))
            sensors[9].append(float(row[9]))
            sensors[10].append(float(row[10]))
            sensors[11].append(float(row[11]))
