...
path1 = "C:\\Users\\chris\\Hybrid-Control\\labjackcoldflow_data.csv"
path1offset = 10000
path2 = "C:\\Users\\chris\\Hybrid-Control\\labjack_data.csv"
path2offset = 10

PATHS = [[path1offset, path1], [path2offset, path2]]
